...
import { type WhoopConfig, loadConfig } from "./config.js";
...
const TOOLS: Tool[] = [
  {
    ...
    description:
      "Get comprehensive WHOOP overview data for a specific date including recovery, strain, sleep, activities, and key statistics",
    inputSchema: {
      type: "object",
      properties: {
        date: {
  ...
  },
  {
    ...
    description:
      "Get detailed sleep analysis including performance, duration, efficiency, stages, and sleep needed",
    inputSchema: {
      type: "object",
      properties: {
        date: {
  ...
  },
  {
    ...
    description:
      "Get comprehensive recovery analysis including score, HRV, RHR, respiratory rate, and trends vs 30-day baseline",
    inputSchema: {
      type: "object",
      properties: {
        date: {
  ...
  },
  {
    ...
    description:
      "Get comprehensive strain analysis including score, heart rate zones, activities, and trends vs 30-day baseline",
    inputSchema: {
      type: "object",
      properties: {
        date: {
  ...
  },
  {
    ...
    description:
      "Get healthspan/biological age data (Note: May not be available in current WHOOP API version)",
    inputSchema: {
      type: "object",
      properties: {
        date: {
